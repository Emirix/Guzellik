-- Migration: Add follow and favorite status to search results
-- Description: Updates search_venues_advanced and elastic_search_venues to return user-specific status

-- 1. Update search_venues_advanced
...
-- 2. Update elastic_search_venues
