-- Migration: Update search RPCs to return features (services)
-- Description: Adds features column to search_venues_advanced and elastic_search_venues

-- First, drop the existing functions to change return types
...
DROP FUNCTION IF EXISTS elastic_search_venues(TEXT, DOUBLE PRECISION, DOUBLE PRECISION, INTEGER, UUID, DOUBLE PRECISION, INTEGER);
...
-- 1. Create/Update search_venues_advanced
...
-- 2. Create/Update elastic_search_venues
